<template>
  <v-container class="pa-6">
    ...
    <v-row v-if="isValid">
      <v-col cols="12">
        <v-card color="orange-lighten-4" class="pa-4 text-center rounded-lg" elevation="0">
      ...
      <v-col cols="12" sm="6">
        <v-card color="deep-orange-lighten-4" class="pa-4 text-center rounded-lg" elevation="0">
      ...
      <v-col cols="12" sm="6">
        <v-card color="yellow-lighten-4" class="pa-4 text-center rounded-lg" elevation="0">
